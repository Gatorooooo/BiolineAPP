...
/*  String timestamp() => DateTime.now().millisecondsSinceEpoch.toString();
  ...
  Future<void> saveInStorage(File file) async {
    ...
    if (statusStorage.isGranted) {
      ...
      debugPrint('No tienes permisos para Guardar el archivo...');
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'No tienes permisos para Guardar el archivo...',
            style: TextStyle(color: Colors.white),
          ),
          ...
          child: Wrap(
            children: [
              ListTile(
                ...
                title: const Text('Escoger foto de la galería'),
                onTap: () {
                  _imageFromGallery();
              ...
              ListTile(
                ...
                title: const Text('Hacer foto con cámara'),
                onTap: () {
                  _imageFromCamera();
                  Navigator.of(context).pop();
                },
